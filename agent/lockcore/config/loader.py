...
from lockcore.config.schema import Config, _resolve_tool_config_refs
...
def get_config_path() -> Path:
    ...
    return Path.home() / ".lockcore" / "config.json"
...
def _apply_ssrf_whitelist(config: Config) -> None:
    ...
    from lockcore.security.network import configure_ssrf_whitelist
