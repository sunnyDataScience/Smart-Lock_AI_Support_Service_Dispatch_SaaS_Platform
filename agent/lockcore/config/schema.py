...
from lockcore.cron.types import CronSchedule

if TYPE_CHECKING:
    from lockcore.agent.tools.cli_apps import CliAppsToolConfig
    from lockcore.agent.tools.image_generation import ImageGenerationToolConfig
    from lockcore.agent.tools.self import MyToolConfig
    from lockcore.agent.tools.shell import ExecToolConfig
    from lockcore.agent.tools.web import WebToolsConfig
...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.lockcore/workspace"
    ...
    bot_name: str = "lockcore"  # Display name shown in CLI prompts (e.g. "{name} is thinking...")
...
class ToolsConfig(Base):
    ...
    web: WebToolsConfig = Field(default_factory=lambda: _lazy_default("lockcore.agent.tools.web", "WebToolsConfig"))
    exec: ExecToolConfig = Field(default_factory=lambda: _lazy_default("lockcore.agent.tools.shell", "ExecToolConfig"))
    cli_apps: CliAppsToolConfig = Field(default_factory=lambda: _lazy_default("lockcore.agent.tools.cli_apps", "CliAppsToolConfig"))
    my: MyToolConfig = Field(default_factory=lambda: _lazy_default("lockcore.agent.tools.self", "MyToolConfig"))
    image_generation: ImageGenerationToolConfig = Field(
        default_factory=lambda: _lazy_default("lockcore.agent.tools.image_generation", "ImageGenerationToolConfig"),
    )
...
class Config(BaseSettings):
    """Root configuration for lockcore."""
    ...
    def _match_provider(
        ...
        *,
        ...
        from lockcore.providers.registry import PROVIDERS, find_by_name
    ...
    def get_api_base(
        ...
        *,
        ...
        from lockcore.providers.registry import find_by_name
...
def _resolve_tool_config_refs() -> None:
    ...
    like ``from lockcore.config.schema import ExecToolConfig`` continue to work.
    """
    import sys
    ...
    from lockcore.agent.tools.self import MyToolConfig
    from lockcore.agent.tools.shell import ExecToolConfig
    from lockcore.agent.tools.web import WebFetchConfig, WebSearchConfig, WebToolsConfig
