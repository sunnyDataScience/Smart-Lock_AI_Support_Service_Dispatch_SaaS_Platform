"""Utility functions for lockcore."""
...
from lockcore.utils.path import abbreviate_path
...
_LEGACY_MODULE_ALIASES = {
    "webui_thread_disk": "lockcore.webui.thread_disk",
    "webui_transcript": "lockcore.webui.transcript",
    "webui_turn_helpers": "lockcore.session.webui_turns",
}
