...
from lockcore.agent.tools.exec_session import (
...
from lockcore.agent.tools.sandbox import wrap_command
from lockcore.agent.tools.schema import BooleanSchema, IntegerSchema, StringSchema, tool_parameters_schema
...
class ExecTool(Tool):
    ...
    def __init__(
        ...
        self.deny_patterns = (deny_patterns or []) + [
            ...
            r":\(\)\s*\{.*\};\s*:",          # fork bomb
            # Block writes to lockcore internal state files (#2989).
    ...
    def _guard_command(self, command: str, cwd: str) -> str | None:
        ...
        from lockcore.security.network import contains_internal_url
