...
from lockcore.agent.tools.path_utils import resolve_workspace_path
from lockcore.agent.tools.schema import ArraySchema, StringSchema, tool_parameters_schema
from lockcore.bus.events import OutboundMessage
from lockcore.config.paths import get_workspace_path
...
class MessageTool(Tool, ContextAware):
    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        from lockcore.utils.helpers import strip_think
