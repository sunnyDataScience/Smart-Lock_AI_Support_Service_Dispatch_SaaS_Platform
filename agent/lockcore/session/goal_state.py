...
def runner_wall_llm_timeout_s(
    ...
    *,
    ...
    """Wall-clock cap for :class:`~lockcore.agent.runner.AgentRunner` when streaming an LLM.
    ...
    caller already holds :attr:`~lockcore.session.manager.Session.metadata` for this turn.
    """
