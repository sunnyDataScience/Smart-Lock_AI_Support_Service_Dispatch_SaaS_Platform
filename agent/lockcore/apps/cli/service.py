...
from lockcore.apps.protocol import app_manifest, compact_dict
from lockcore.config.paths import get_runtime_subdir
...
class CliAppManager:
        ...
        *,
        ...
        remove = compact_dict({
            ...
            "verification": (
                ...
                else ["lockcore_state_absent", "managed_paths_absent"]
            ),
        })
        return app_manifest(
            app_id=name,
    ...
    def _fallback_skill(self, app: dict[str, Any]) -> str:
        ...
        description = str(app.get("description") or f"Use {display} from lockcore.")
        return f"""---
...
Use this skill when the user asks lockcore to operate {display} through its installed CLI app.
...
"""
    ...
    def _with_lockcore_skill_note(self, content: str, app: dict[str, Any]) -> str:
        marker = "<!-- lockcore-cli-app-note -->"
...
"""
    ...
    def install_skill(self, app: dict[str, Any]) -> Path:
        ...
        content = self._with_lockcore_skill_note(content, app)
    ...
    def uninstall(self, name: str) -> dict[str, Any]:
        ...
        if strategy == "bundled" and still_available:
            message = (
                f"Removed {app['display_name']} from lockcore. {entry_point} "
                "is still available because it is managed outside lockcore."
            )
