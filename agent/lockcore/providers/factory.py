...
from lockcore.config.schema import Config, InlineFallbackConfig, ModelPresetConfig
...
def _make_provider_core(
    ...
    *,
    ...
    # [lock-cs-agent] 統一用 LiteLLMProvider(多供應商),取代 nanobot 各家 provider。
    # litellm 靠 model 字串路由(claude-* / gpt-4o / bedrock/* / azure/* / openrouter/* …)。
