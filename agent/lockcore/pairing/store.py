...
Persistent storage at ``~/.lockcore/pairing.json`` keeps approved senders
...
from lockcore.config.paths import get_data_dir
from lockcore.utils.helpers import _write_text_atomic
