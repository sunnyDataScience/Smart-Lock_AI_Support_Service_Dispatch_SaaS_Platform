...
_APP_KEYWORDS: dict[str, list[str]] = {
    "app-pairing": ["配對", "WiFi", "藍牙", "連線", "新增裝置", "綁定"],
    "app-remote": ["遠端", "遠程", "遠距", "遠端開鎖"],
    "app-temp-pwd": ["臨時密碼", "暫時密碼", "一次性密碼", "temporary"],
    "app-camera": ["攝影", "鏡頭", "影像", "即時影像", "錄影"],
    "app-family": ["家庭", "家人", "成員管理", "家庭群組"],
    "app-unbind": ["解綁", "解除綁定", "換手機", "移除裝置"],
    "app-user-mgmt": ["使用者管理", "指紋管理", "密碼管理", "人臉", "掌紋", "門卡"],
    "app-settings": ["設定", "音量", "語言", "音效", "語音"],
    "app-battery": ["電池", "充電", "電量顯示", "低電量"],
