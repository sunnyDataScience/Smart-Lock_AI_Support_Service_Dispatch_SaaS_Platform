...
-- requested_by 全部指向 test@lock-ai.com（c782bcfe...），代表客服代客申請
...
INSERT INTO refund_requests (
    ...
    (
        ...
        'escalated',
        '[{"actor":"test@lock-ai.com","decision":"escalate","reason":"金額超過授權額度","at":"2026-04-28T18:00:00Z"}]'::jsonb,
        true,
        NULL,
    ...
    (
        ...
        'approved',
        '[{"actor":"test@lock-ai.com","decision":"approve","reason":"工單未派遣，車馬費應退","at":"2026-04-28T22:00:00Z"}]'::jsonb,
        false,
        NULL,
    ...
    (
        ...
        '美樂電子鎖工單部分折讓（耗材費爭議）',
        'executed',
        '[{"actor":"test@lock-ai.com","decision":"approve","reason":"折讓 NT$500","at":"2026-04-26T10:00:00Z"},{"actor":"test@lock-ai.com","decision":"execute","reason":"已透過第三方支付退款","at":"2026-04-27T15:00:00Z"}]'::jsonb,
        false,
        NOW() - INTERVAL '2 days',
        NOW() - INTERVAL '3 days',
        NOW() - INTERVAL '2 days'
