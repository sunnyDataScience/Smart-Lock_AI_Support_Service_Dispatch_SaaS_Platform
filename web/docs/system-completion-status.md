...
**最後更新：** 2026-06-04（CR-0012 CIA opened — FR-0012 技師月結撥款 6 HD 等業主裁；與 CR-0011 形成 V1.0 金流閉環雙 CIA，HD-06 escrow 模型須與 CR-0011 HD-08 同步裁決）
**對應分支：** `docs/cr-0012-fr-0012-monthly-settlement-cia`（基於 dev_new_arch HEAD `4ff6373c`）
