...
export interface paths {
    ...
    "/api/v1/platform/service-principals": {
        ...
        /** 列出服務主體（永不回傳 credential secret/hash） */
        get: operations["listServicePrincipals"];
        put?: never;
        /** 建立服務主體並一次性簽發第一把 credential */
    ...
    "/api/v1/platform/service-credentials/{credential_id}:rotate": {
        ...
        get?: never;
        put?: never;
        /** 輪替 credential；新 secret 僅回傳一次，舊 credential 依 overlap 到期 */
    ...
    "/api/v1/platform/service-credentials/{credential_id}:revoke": {
        ...
        put?: never;
        /** 撤銷 credential */
        post: operations["revokeServiceCredential"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/tenants/{tenantId}/me/preferences": {
        ...
        /** 列出品牌人員跨裝置偏好 */
        get: operations["listBrandUserPreferences"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/tenants/{tenantId}/me/preferences/{preferenceKey}": {
        ...
        get?: never;
        /** 以版本 CAS 儲存品牌人員偏好 */
        put: operations["putBrandUserPreference"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/v1/technicians/me/preferences": {
        ...
        /** 列出技師跨裝置偏好 */
        get: operations["listTechnicianPreferences"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/technicians/me/preferences/{preferenceKey}": {
        ...
        get?: never;
        /** 以版本 CAS 儲存技師偏好 */
        put: operations["putTechnicianPreference"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/v1/platform/me/preferences": {
        ...
        /** 列出平台管理員跨裝置偏好 */
        get: operations["listPlatformPreferences"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/platform/me/preferences/{preferenceKey}": {
        ...
        get?: never;
        /** 以版本 CAS 儲存平台治理偏好 */
        put: operations["putPlatformPreference"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/tenants/{tenantId}/role-assignments": {
        ...
        /** 角色變更提案清單(?status=proposed 為待核佇列) */
        get: operations["listRoleAssignments"];
        put?: never;
        /** 提案角色變更(SoD step-1;提案人=當前 admin) */
        post: operations["proposeRoleAssignment"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/tenants/{tenantId}/role-assignments/{assignmentId}:approve": {
        ...
        get?: never;
        put?: never;
        /** 核准並套用(SoD step-2+3;核准人≠提案人否則 403) */
        post: operations["approveRoleAssignment"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/tenants/{tenantId}/role-assignments/{assignmentId}:reject": {
        ...
        put?: never;
        /** 拒絕提案(擋壞提案不需雙人) */
        post: operations["rejectRoleAssignment"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        /** ReviewBody */
        routers__role_assignments__ReviewBody: {
            /** Reason */
            reason?: string | null;
        };
        /** ApproveBody */
...
export interface operations {
    ...
    refreshPlatformToken: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["PlatformRefreshBody"] | null;
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    createServicePrincipal: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PrincipalCreateBody"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    ingestSkillRevision: {
        parameters: {
            query?: never;
            header?: {
                "X-Service-Credential"?: string | null;
    ...
    rejectRoleAssignment: {
        ...
        requestBody?: {
            content: {
                "application/json": components["schemas"]["routers__role_assignments__ReviewBody"] | null;
            };
        };
        responses: {
            /** @description Successful Response */
