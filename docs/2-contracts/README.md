...
| `pages/` | 每 page 一份 contract（route、auth、data、CTA、nav） | `docs/02-design/E5x--frontend-information-arch.md` (52 頁) + `docs/_archive/legacy/web_design_spec_prompt_pipeline/pages/*` (22 spec) SPLIT |
| `frontend-design-system.md` | tokens、atomic design、API client、auth、frontend security | `docs/02-design/E5x--frontend-architecture` + `docs/_archive/legacy/web_design_spec_prompt_pipeline/{global/02_smartlock_*, design-system-specs/smartlock/*}` |
