...
source_spec_path: docs/legacy/web_design_spec_prompt_pipeline/pages/12_tech_my_orders.md
...
- 來源：`docs/legacy/web_design_spec_prompt_pipeline/pages/12_tech_my_orders.md`
- 區段：詳情段
- 對應 docs 路徑：`docs/extras/web-frontend/pages-legacy/12_tech_my_orders.md` (Phase 8 後移到此)
