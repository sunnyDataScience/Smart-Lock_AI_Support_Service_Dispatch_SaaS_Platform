...
source_spec_path: docs/_archive/legacy/web_design_spec_prompt_pipeline/pages/22_reschedule_calendar.md
...
- 來源：`docs/_archive/legacy/web_design_spec_prompt_pipeline/pages/22_reschedule_calendar.md`
- 區段：主要
- 對應 docs 路徑：`docs/_archive/extras/web-frontend/pages-legacy/22_reschedule_calendar.md` (Phase 8 後移到此)
