...
source_spec_path: docs/legacy/web_design_spec_prompt_pipeline/pages/02_admin_dashboard.md
...
- 來源：`docs/legacy/web_design_spec_prompt_pipeline/pages/02_admin_dashboard.md`
- 區段：主要
- 對應 docs 路徑：`docs/extras/web-frontend/pages-legacy/02_admin_dashboard.md` (Phase 8 後移到此)
