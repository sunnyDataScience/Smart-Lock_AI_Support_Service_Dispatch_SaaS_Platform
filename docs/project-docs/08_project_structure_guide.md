...
`docs/system_design/specs/` 目錄下包含 14 份 V2.0 設計規格文件：
...
| V2.0 Design Specs | `docs/system_design/specs/*.md` | Yes |
...
- 任何**頂層目錄結構**的變更，必須透過 ADR（Architecture Decision Record）記錄至 `docs/adrs/`。
...
| 查看 GAP 分析 | `docs/system_design/gap/GAP_ANALYSIS_REPORT_CN.md` |
| 查看 V2.0 設計規格 | `docs/system_design/specs/` |
