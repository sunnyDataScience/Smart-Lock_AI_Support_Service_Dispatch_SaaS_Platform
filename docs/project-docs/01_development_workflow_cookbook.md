...
| 階段 | 文件 | 狀態 | 文件路徑 |
|:-----|:-----|:-----|:---------|
| **規劃** | 專案簡報與 PRD | 已批准 | `docs/project-docs/02_project_brief_and_prd.md` |
| **規劃** | BDD 情境 | 活躍 | `docs/project-docs/03_behavior_driven_development.md` |
| **設計** | 架構與設計文檔 | 已批准 | `docs/project-docs/05_architecture_and_design_document.md` |
| **設計** | ADR (6 份) | 已決策 | `docs/adrs/adr-001 ~ adr-006` |
| **設計** | API 設計規格 | 已批准 | `docs/project-docs/06_api_design_specification.md` |
| **設計** | 資料庫 Schema | 已定義 | `SQL/Schema.sql` |
| **設計** | 資料庫 Schema V2.0 Extensions | 已定義 | `SQL/Schema_v2_extensions.sql` |
| **設計** | V2.0 系統設計規格 (14 份) | 活躍 | `docs/system_design/specs/` |
| **設計** | Agent Harness 重構文件 | 活躍 | `docs/agent-harness-refactor/` |
| **設計** | 護城河映射矩陣 | 已完成 | `docs/system_design/specs/moat-mapping-matrix.md` |
| **開發** | 模組規格與測試 | 草稿 | `docs/project-docs/07_module_specification_and_tests.md` |
| **開發** | V2.0 業務服務模組 (16 個) | 活躍 | `agent/services/` |
| **開發** | 模組依賴關係 | 草稿 | `docs/project-docs/09_file_dependencies.md` |
| **開發** | 類別關係文檔 | 草稿 | `docs/project-docs/10_class_relationships.md` |
| **品質** | 品質檢查清單 | 使用中 | `docs/project-docs/13_security_and_readiness_checklists.md` |
| **品質** | 部署與運維指南 | 草稿 | `docs/project-docs/14_deployment_and_operations_guide.md` |
| **品質** | Code Review 指南 | 草稿 | `docs/project-docs/11_code_review_and_refactoring_guide.md` |
| **支援** | 專案結構指南 | 活躍 | `docs/project-docs/08_project_structure_guide.md` |
| **支援** | 前端架構規範 | 草稿 | `docs/project-docs/12_frontend_architecture_specification.md` |
| **支援** | 前端信息架構 | 草稿 | `docs/project-docs/17_frontend_information_architecture.md` |
| **支援** | 文檔與維護指南 | 草稿 | `docs/project-docs/15_documentation_and_maintenance_guide.md` |
| **支援** | 系統架構總覽 | 已完成 | `docs/project-docs/executive_architecture_overview.md` |
| **支援** | WBS 開發計畫 | 已定義 | `docs/project-docs/WBS_電子鎖智能平台.md` |
