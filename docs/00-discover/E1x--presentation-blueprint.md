---
status: superseded
superseded_by: docs_v2/business/presentation-blueprint.md
...
| 6 | AI 三層解決機制 | 核心競爭力的視覺化 | 2min |
| 7 | 功能模組地圖 | V1.0 / V2.0 交付範圍一覽 (含 16 個 V2.0 服務模組) | 2min |
| 8 | 交付時程 | 甘特圖，兩階段里程碑 | 2min |
| 9 | 成功指標 | KPI 儀表板式呈現 | 1min |
| 10 | 商業效益 | Before vs After 對比 | 2min |
| 11 | 風險與對策 | 風險矩陣 | 1min |
| 12 | 下一步行動 | 明確請求決策 | 1min |
| 13 | 護城河映射 | 投資人 5 項 vs 系統 10 項的競爭壁壘映射 | 2min |
...
| 三層解決機制 | `fa:fa-lightbulb-o` | 燈泡 | `Lightbulb` |
...
```
          ...
          ├─────────────────────────────┤
          │       AI 服務層             │  LangChain | Gemini 2.5 Flash [^1]
          ├─────────────────────────────┤
          │      業務領域層             │  客服 | 知識庫 | 派工 | 帳務
          ├─────────────────────────────┤
...
```
  ...
  ┌──────────────────────────────────────────┐
  │  L2 - AI 推理生成                        │  🤖 <8秒
  │  Gemini 2.5 Flash RAG，組合知識庫+手冊推理 │  🎯 預估解決 35%
  └──────────────┬───────────────────────────┘
           無解 ▼
  ┌──────────────────────────────────────────┐
  │  L3 - 轉派工                             │  👷 自動建工單
...
```
  V1.0 AI 智能客服 (W1-W17)          V2.0 派工與帳務 (W18-W34)
  ┌─────────────────────────┐        ┌─────────────────────────┐
...
### P13. 護城河映射 (Moat Mapping)

**核心訊息**：投資人關注的 5 項競爭護城河，系統已覆蓋 10 項技術實現

**圖表類型**：**雙欄映射表** (左：投資人視角 / 右：系統技術實現)

```
  投資人護城河 (5 項)                    系統技術實現 (10 項)
  ┌──────────────────────┐              ┌──────────────────────┐
  │ 1. 數據壁壘           │ ──────────> │ 知識庫自進化迴路      │
  │                       │             │ 案例庫持續累積        │
  ├──────────────────────┤              ├──────────────────────┤
...
> 詳見 `docs/00-discover/moat-mapping-matrix.md`
