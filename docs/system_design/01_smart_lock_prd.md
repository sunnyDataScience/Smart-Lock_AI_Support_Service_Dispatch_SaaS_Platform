...
**專案代號:** `SmartLock-SaaS`
**狀態:** 已批准 (Approved)
**SSOT 來源:** `docs/02_project_brief_and_prd.md`
...
| **管理員 (Admin)** | 甲方營運人員 / 客服主管 | Admin Panel | 知識庫管理、對話監控、派工監控、帳務審核、營運儀表板 |
...
| **增強管理後台** | 派工監控儀表板、技師管理、帳務審核、案件全生命週期追蹤、客訴處理 (Next.js 14 + shadcn/ui) |
