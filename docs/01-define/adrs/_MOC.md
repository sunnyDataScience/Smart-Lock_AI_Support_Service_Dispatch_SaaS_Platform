...
| [[adr-009-agent-admin-bridge-pattern]] | Agent ↔ Admin tables 寫入機制 | **Proposed**（推薦 D：HTTP call to admin API，待拍板）| A. Direct DB write / B. Outbox / C. Event Bus / E. Shared service |
