---
status: superseded
superseded_by: SPLIT: docs_v2/2-contracts/pages/ + docs_v2/5-views/frontend-route-map.md
...
| **工單互動流程** | E5x--workflow-work-order.md | `docs/_flows-bdd-test/v-model-left/E5x--workflow-work-order.md` |
| **派工營運規格** | E5x--workflow-dispatch.md | `docs/_flows-bdd-test/v-model-left/E5x--workflow-dispatch.md` |
