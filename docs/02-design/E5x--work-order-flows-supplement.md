...
> **參考文件**：
> - `docs/02-design/E5x--work-order-interaction-flows.md` — 主文件 (Flow 1-10, §1-§15)
> - `docs/_gap-analysis/gap-analysis-report.md` — 缺口分析報告
> - `docs/_domain-knowledge/requirements/09_pricing_rules/README.md` — 定價規則
