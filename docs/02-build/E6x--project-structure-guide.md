...
`docs/02-build/specs/` 目錄下包含 14 份 V2.0 設計規格文件：
...
| V2.0 Design Specs | `docs/02-build/specs/*.md` | Yes |
...
- 任何**頂層目錄結構**的變更，必須透過 ADR（Architecture Decision Record）記錄至 `docs/01-design/adrs/`。
...
| 查看 GAP 分析 | `docs/05-gap-analysis/gap-analysis-report-cn.md` |
| 查看 V2.0 設計規格 | `docs/02-build/specs/` |
