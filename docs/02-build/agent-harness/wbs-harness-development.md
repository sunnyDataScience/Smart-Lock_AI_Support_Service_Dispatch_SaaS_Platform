...
| 9.2 | 14 design specifications | docs/02-build/specs/ | COMPLETE | [x] |
| 9.3 | SQL Schema extensions | SQL/Schema_v2_extensions.sql (6 new tables) | COMPLETE | [x] |
| 9.4 | ADR-006 LLM model selection | docs/01-design/adrs/adr-006-llm-model-selection.md | COMPLETE | [x] |
