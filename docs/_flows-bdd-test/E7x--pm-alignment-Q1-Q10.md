...
| # | 問題 | 預設 | PM 決策 | 拍板日 | 影響 sprint |
|---|------|------|---------|--------|------------|
| Q1 | 派工員角色 | A 新角色 | ⬜ 待拍 | — | F-004 / F-019 |
| Q2 | 雙簽終簽人 | A 階層 | ⬜ 待拍 | — | F-013 / F-014 |
| Q3 | 消費者追蹤入口 | A LINE only | ⬜ 待拍 | — | F-022 |
| Q4 | 月結 SLA 計時 | B 自然日 | ⬜ 待拍 | — | F-013 |
| Q5 | F-016 SLA 屬性 | B Soft | ⬜ 待拍 | — | F-016 / F-013 / F-014 |
| Q6 | 客服繞過派工 | A 可 + audit | ⬜ 待拍 | — | F-004 |
| Q7 | V1.0 金流 | A 不含 | ⬜ 待拍 | — | F-011 / F-014 / 整體 V1.0 |
| Q8 | 非 LINE fallback | A 拒收 | ⬜ 待拍 | — | F-001 / F-010 |
| Q9 | Scope Change 同意 | A LINE quick reply | ⬜ 待拍 | — | F-008 |
| Q10 | 派工失敗 rollback | A 重派 3 次 | ⬜ 待拍 | — | F-003 / F-005 |
