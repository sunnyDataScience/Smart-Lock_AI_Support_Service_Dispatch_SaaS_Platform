...
version: 1.0
status: superseded
superseded_by: ./ADR-028_web檔案層拆分_monorepo_workspaces.md
...
| 欄位 | 內容 |
|---|---|
| 狀態 | **Superseded by [ADR-028](./ADR-028_web檔案層拆分_monorepo_workspaces.md)**（2026-07-08 業主裁決檔案層真拆；APP_MODE 塑形機制保留但單一 app 架構退場） |
| 層級 | 系統級（web）|
