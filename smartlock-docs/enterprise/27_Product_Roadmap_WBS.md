...
| 1.4.1 | 🔶 code 面 ✅（CR-0136 api＋CR-0156 agent/refinery/web-參考實作＋agent OPIK 接線＋PII scrub 全面，2026-07-10）；殘＝SigNoz 叢集部署與 OPIK/OTLP secrets 配置（OPS）＋三站複製 | 可觀測性：SigNoz（metrics/logs/traces/alerts）+ OPIK（LLM 品質）基線 | OPS+AG | — | ADR-007；25_Monitoring_Spec |
