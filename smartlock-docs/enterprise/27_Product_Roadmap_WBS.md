...
|---|---|---|---|---|---|
| 1.1.1 | 🔶 R1 ✅ 2026-07-09（CR-0130：死角色全面移除＋金流/派工/設定 49 端點守衛＋技師白名單；R2＝43 個非核心寫入端點灰度，見 CR-0130 附表） | RBAC 轉 enforce：195 條 `role_required` 對帳 + 逐端點落地（先金流 / 派工）| BE | 1.1.2 | SA-01；未授權角色寫入 403（TC 權限類全綠）|
