...
| **E. 報價 / 目錄** | `quote`、`quote_approval`、`quote_line_items`(037)、`service_catalog`、`material_catalog`、`surcharge_rule`(087)、`saas.price_rule`(008)、`technician_payout_rule`(045/082)、`pricing_rule_snapshot` | public / saas 〔標注 2026-07-10：`pricing_rule_snapshot` 自 098 改 content-addressable（ADR-026/CR-0149，sha256 PK＋append-only trigger）；舊制更名 `pricing_rule_snapshot_legacy` 保留〕|
