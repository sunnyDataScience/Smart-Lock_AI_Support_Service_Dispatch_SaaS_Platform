...
| 認證 | token 刷新（401 → refresh once → 重放）；失敗清 token 導登入 | httpOnly cookie + server 端驗簽 + Next middleware gate（ACT-01，Phase 2）|
...
*文件結尾 — 13_Security_Architecture.md v1.0 / 2026-07-07*
