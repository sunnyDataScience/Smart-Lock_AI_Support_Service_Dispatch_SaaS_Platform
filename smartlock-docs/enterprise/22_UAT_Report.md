...
- **範圍**：S1–S9 的九組 UAT 腳本（覆蓋 19 條 `SC-*` 情境）+ 14 類上線前人工驗收檢查（§3）+ KPI 門檻（§5）。
...
| **品牌小編（租戶操作方）** | 派工/工單/報價後台操作點測；可見性驗證 | 旅程 S2/S6 簽核 |
| **CS team（客服主管）** | AI 對話品質、接管流程、退款雙簽點測 | 旅程 S1/S4/S6 簽核 |
| **師傅（技師代表）** | 師傅 web 接單/現場/完工流程點測 | 旅程 S2/S7/S8 簽核 |
...
- **Pass**：14 類檢查全過 + S1–S9 全簽核 + KPI 達標 + P0/P1 清零。
