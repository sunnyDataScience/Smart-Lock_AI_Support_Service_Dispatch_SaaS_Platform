...
- [SmartLock_業務邏輯驗收控制表.xlsx](./SmartLock_業務邏輯驗收控制表.xlsx) — 42,006 bytes
- [SmartLock_模組功能BOM.xlsx](./SmartLock_模組功能BOM.xlsx) — 66,536 bytes
- [SmartLock_整合測試計畫.xlsx](./SmartLock_整合測試計畫.xlsx) — 56,342 bytes
- [SmartLock_規格統控規劃書.xlsx](./SmartLock_規格統控規劃書.xlsx) — 26,893 bytes
...
`OD-002` knowledge-refinery 的資料進入契約、`OD-003` 技師即時 WebSocket 的權威歸屬。
