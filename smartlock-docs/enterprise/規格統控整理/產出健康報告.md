...
> Codebase 快照：`dev-ding@e000f1fe`（統控基線 `ddc6f986`）<br>
...
- [SmartLock_業務邏輯驗收控制表.xlsx](./SmartLock_業務邏輯驗收控制表.xlsx) — 28,626 bytes
- [SmartLock_模組功能BOM.xlsx](./SmartLock_模組功能BOM.xlsx) — 63,958 bytes
- [SmartLock_整合測試計畫.xlsx](./SmartLock_整合測試計畫.xlsx) — 55,818 bytes
- [SmartLock_規格統控規劃書.xlsx](./SmartLock_規格統控規劃書.xlsx) — 24,402 bytes
