...
- [SmartLock_業務邏輯驗收控制表.xlsx](./SmartLock_業務邏輯驗收控制表.xlsx) — 42,012 bytes
- [SmartLock_模組功能BOM.xlsx](./SmartLock_模組功能BOM.xlsx) — 63,959 bytes
- [SmartLock_整合測試計畫.xlsx](./SmartLock_整合測試計畫.xlsx) — 56,338 bytes
- [SmartLock_規格統控規劃書.xlsx](./SmartLock_規格統控規劃書.xlsx) — 26,491 bytes
- [SAD_SDS元件標籤字典.md](./SAD_SDS元件標籤字典.md) — 78,370 bytes
...
`OD-001` OHS 服務間憑證模式、`OD-002` knowledge-refinery 的資料進入契約、`OD-003` 技師即時 WebSocket 的權威歸屬、`OD-004` Casdoor 跨租戶 organization 與 claim 模型。
