...
>
> 〔標注 2026-07-11（業主裁決，UAT 定案）：K3 編號維持本表「家族覆核履約」義；05_NFR／04_SRS 將 K3 對映之「負面情緒識別 ≥ 90%」義項同屬合約紅線（合約 4.4(a)），UAT **兩者並列驗收**、各依自身門檻判分。〕
