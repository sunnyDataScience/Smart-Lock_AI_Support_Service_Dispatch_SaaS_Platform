...
> 〔標注 2026-07-22：本表 stage 4「資料連 3 次收不齊自動轉」已由 SOP 演進取代——缺項情境式一次列齊、紅線觸發即轉（[ADR-033](./14_ADR/ADR-033_轉真人判準_SOP情境式紅線_取代三輪硬計數.md)）；stage 3「clarify gate 主動確認」保留為話術原則，三層解決（案例庫→RAG→轉真人）分流定位不變。〕
