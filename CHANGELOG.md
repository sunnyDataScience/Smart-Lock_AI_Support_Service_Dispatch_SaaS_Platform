...
- **ADR INDEX.md catch-up ADR-0100~0107 + special variants**（branch `docs/adr-index-catchup-0100-0107`，2026-06-05）：承接 commit `8e7dc1ce` (ADR-0107 follow-up) 標示的 OOSCope 後續工作 — INDEX.md 為 2026-05-21 初版結構（覆蓋 Group 1 GAP / Group 2 P0 / Group 3 AI 跟進 / Group 4 2026-05-22 會議新增 = ADR-0031~0059），未跟上後續 ADR-0100~0107 與 special variants (ADR-VCH-001/002 / ADR-PIVOT-001 / ADR-PII-002)。**新增 Group 5 — 2026-05-28 至 2026-06-05 新增**：列 ADR-0100 (legacy supersede index) / ADR-0101 (KB integration, ⚠️ superseded by ADR-0107) / ADR-0102 (取消費 v2) / ADR-0103 (KB v2) / ADR-0104 (SOP v2) / ADR-0105 (Reschedule+DoorCheck v2) / ADR-0106 (agent single-actor refund) / **ADR-0107 (lockcore supersede trio, ⭐ Architecture lock)**。**新增 Group 6 — Special variants**：列 ADR-VCH-001 (voucher keeper) / ADR-VCH-002 (voucher 7y retention) / ADR-PIVOT-001 (V2 restart trigger) / ADR-PII-002 (PII data minimization + CI 雙保險)。新加圖例：⚠️ superseded / ⭐ 重大架構決策。**設計取捨**：(a) 不破壞 Group 1-4 既有結構，純 append Group 5/6；(b) Group 5 內 ADR-0101 標 ⚠️ 提醒 superseded by ADR-0107（與 frontmatter 雙重防護）；(c) Group 6 收 special variants（VCH/PIVOT/PII 編號）統一收編避免散落。**WBS 影響**：governance 索引 catch-up 完成；無 code 變更。
