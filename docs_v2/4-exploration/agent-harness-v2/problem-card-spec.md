---
id: PCS-V2
title: ProblemCard Specification — V2.0 Future Design
tier: 4
status: draft
...
related:
  ...
  - "../../2-contracts/modules/problem-card-engine.md (V1.0 canonical)"
legacy_id: 02-design/agent-harness/problem-card-spec.md
moved_from: docs_v2/2-contracts/modules/problem-card-engine.md (was misplaced as V1 contract)
moved_via: CR-0001 Phase 7-13 cleanup 2026-05-10
---
