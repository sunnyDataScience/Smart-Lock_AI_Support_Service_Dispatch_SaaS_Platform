---
status: superseded
superseded_by: "[[00-discover/E1--project-brief-and-prd]]"
---

# (Superseded) 產品需求文件 (PRD) - 電子鎖智能客服與派工平台

> **This document has been superseded.** The canonical PRD is now at [[00-discover/E1--project-brief-and-prd]] (v1.1).
...
**專案代號:** `SmartLock-SaaS`
**狀態:** Superseded
**SSOT:** [[00-discover/E1--project-brief-and-prd]]
