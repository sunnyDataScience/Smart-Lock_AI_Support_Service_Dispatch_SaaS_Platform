...
source_spec_section: case_form_modal
legacy_id: IA-A7
---
...
TODO（待對照 `web/src/app/knowledge-base/cases/[id]` 的 components 與 `../frontend-design-system/02-components.md`）
