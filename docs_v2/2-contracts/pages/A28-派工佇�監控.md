...
trace_to_fr: FR-0003-auto-dispatch monitoring
related:
...
FR-0003-auto-dispatch monitoring
...
TODO（待對照 `web/src/app/admin/dispatch-queue` 的 components 與 `../frontend-design-system/02-components.md`）
