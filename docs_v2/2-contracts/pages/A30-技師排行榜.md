...
route: /admin/reports/technician-ranking
version: V2.0
...
TODO（待對照 `web/src/app/admin/reports/technician-ranking` 的 components 與 `../frontend-design-system/02-components.md`）
