...
FR-0018-cs-takeover (diagnostic view)
...
TODO（待對照 `web/src/app/admin/diagnostics/[conversation_id]` 的 components 與 `../frontend-design-system/02-components.md`）
