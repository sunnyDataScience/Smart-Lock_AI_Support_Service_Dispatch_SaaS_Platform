...
trace_to_fr: customer master data
related:
...
TODO（待對照 `web/src/app/admin/customers/[id]` 的 components 與 `../frontend-design-system/02-components.md`）
