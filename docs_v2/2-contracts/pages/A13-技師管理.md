...
source_spec_path: web_design_spec_prompt_pipeline/pages/08_admin_technicians.md
...
- 來源：`web_design_spec_prompt_pipeline/pages/08_admin_technicians.md`
- 區段：列表段
- 對應 docs_v2 路徑：`docs_v2/extras/web-frontend/pages-legacy/08_admin_technicians.md` (Phase 8 後移到此)
...
TODO（待對照 `web/src/app/technicians` 的 components 與 `../frontend-design-system/02-components.md`）
