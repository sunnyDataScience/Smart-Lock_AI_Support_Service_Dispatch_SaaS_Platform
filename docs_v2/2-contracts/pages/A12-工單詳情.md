...
source_spec_path: web_design_spec_prompt_pipeline/pages/07_admin_work_order_detail.md
...
- 來源：`web_design_spec_prompt_pipeline/pages/07_admin_work_order_detail.md`
- 區段：主要
- 對應 docs_v2 路徑：`docs_v2/extras/web-frontend/pages-legacy/07_admin_work_order_detail.md` (Phase 8 後移到此)
