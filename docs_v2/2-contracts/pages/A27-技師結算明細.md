...
route: /admin/technicians/[id]/settlements
version: V2.0
...
TODO（待對照 `web/src/app/admin/technicians/[id]/settlements` 的 components 與 `../frontend-design-system/02-components.md`）
