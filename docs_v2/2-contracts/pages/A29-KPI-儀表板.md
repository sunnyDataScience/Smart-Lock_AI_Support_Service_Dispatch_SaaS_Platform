...
source_spec_path: web_design_spec_prompt_pipeline/pages/17_admin_dispatch_queue_and_reports.md
source_spec_section: A29 子段
legacy_id: IA-A29
---
...
- 來源：`web_design_spec_prompt_pipeline/pages/17_admin_dispatch_queue_and_reports.md`
- 區段：A29 子段
- 對應 docs_v2 路徑：`docs_v2/extras/web-frontend/pages-legacy/17_admin_dispatch_queue_and_reports.md` (Phase 8 後移到此)
...
TODO（待對照 `web/src/app/admin/reports/kpi` 的 components 與 `../frontend-design-system/02-components.md`）
