...
route: /admin/technicians/[id]/skills
version: V2.0
...
TODO（待對照 `web/src/app/admin/technicians/[id]/skills` 的 components 與 `../frontend-design-system/02-components.md`）
