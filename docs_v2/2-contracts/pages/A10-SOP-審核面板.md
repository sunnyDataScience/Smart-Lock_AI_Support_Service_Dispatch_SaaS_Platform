...
route: /knowledge-base/sop-drafts/[id]
version: V1.0
...
TODO（待對照 `web/src/app/knowledge-base/sop-drafts/[id]` 的 components 與 `../frontend-design-system/02-components.md`）
