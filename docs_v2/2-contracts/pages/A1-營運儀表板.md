...
source_spec_path: web_design_spec_prompt_pipeline/pages/02_admin_dashboard.md
...
- 來源：`web_design_spec_prompt_pipeline/pages/02_admin_dashboard.md`
- 區段：主要
- 對應 docs_v2 路徑：`docs_v2/extras/web-frontend/pages-legacy/02_admin_dashboard.md` (Phase 8 後移到此)
